    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <FloatingSticker emoji="🤖" label="Robot"       className="top-56 left-[38%]   hidden xl:block" delay={1.3} rotation={-4} />
          <FloatingSticker emoji="🧬" label="DNA"         className="top-72 right-[35%]  hidden xl:block" delay={1.5} rotation={7}  />
