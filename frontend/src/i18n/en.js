export const en = {
  ...
  method: [
    ...
    },
    {
      ...
      description: "Children identify and prepare what they need.",
    },
    {
      step: 3,
      title: "Investigation",
      description:
        "Hands-on experiment, including outdoor activities where relevant.",
    },
    {
      step: 4,
      title: "Observation",
      description: "Children record what they see, measure, and notice.",
    },
    {
      step: 5,
      title: "Results",
      description: "Data is collected, counted, and compared.",
    },
    {
      step: 6,
      title: "Conclusion",
  ...
  whatIsSteam: {
    ...
    s1Sub:
      "STEAM stands for Science, Technology, Engineering, Art, and Mathematics — an integrated way of thinking that connects five disciplines into one investigative approach. Rather than teaching subjects in isolation, STEAM shows children how everything is connected.",
    ...
    s3Body1:
      "STEAM did not emerge from a single idea — it evolved over three decades of research, policy-making, and classroom practice across four continents. It began as STEM in the United States in the early 1990s, driven by concerns that students were not developing the scientific and technical skills the modern economy needed.",
    s3Body2:
    ...
    s3Body3:
      "Stanford University's research in the 1980s had already shown that children who engage in arts-integrated learning retain science concepts significantly longer. STEAM simply made that connection official — and built it into the curriculum.",
    s3Quote:
      "“STEAM is not about adding art to STEM. It is about recognising that creative thinking is the engine that makes science meaningful.”",
    s3QuoteCite:
      "— Georgette Yakman, founder of the STEAM framework (2006)",
    s4Overline: "Global adoption",
    s4Title: "Who Follows STEAM?",
    s4Sub:
      "From government policy to classroom practice — STEAM is the world's fastest-growing education movement.",
    ...
    stats: [
      {
        value: "65%",
        label:
          "of today's children will work in jobs that don't exist yet",
      },
      {
        value: "3×",
        label:
          "more likely to study STEAM with early childhood exposure",
      },
      {
        value: "40+",
      ...
      },
      {
        value: "1987",
        label:
          "year Stanford proved arts integration boosts science retention",
      },
    ],
    timeline: [
      {
      ...
      items: [
        {
          ...
          desc: "Focused workshop experiences built around themed scientific exploration, practical discovery, and meaningful hands-on learning.",
    ...
    latest: {
      ...
      items: [
        ...
        },
        {
          ...
          href: "https://www.linkedin.com/pulse/shifting-paradigm-moving-from-special-education-g8r0f/",
          cta: "Read on LinkedIn",
          external: true,
        },
        {
          ...
          href: "https://www.linkedin.com/pulse/embracing-stumble-building-academic-resilience-teaching-sjjwe/",
          cta: "Read on LinkedIn",
          external: true,
        },
        {
  ...
  register: {
    ...
    subtext:
      "Spots are limited to a maximum of 10 children to ensure every child receives personal attention. Submit the form and you will receive a response within 24 hours.",
    promises: [
